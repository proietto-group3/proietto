...
from ads.views import AddAdView, AdDeleteView, AdDetailView, AllAdsListView, EditAdView, TagAdListView
...
urlpatterns = [
    ...
    path('tag/<slug:slug>/', TagAdListView.as_view(), name='tag_ad_list'),
